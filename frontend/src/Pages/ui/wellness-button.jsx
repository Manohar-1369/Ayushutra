...
import { cn } from "../../lib/utils.js"; // adjust the path as per your project
...
const wellnessButtonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-wellness",
        healing:
          "bg-wellness-green text-white hover:bg-wellness-green/90 shadow-wellness hover:shadow-glow",
        wellness:
          "bg-gradient-to-r from-wellness-green to-wellness-blue text-white hover:opacity-90 shadow-wellness",
        medical:
          "bg-wellness-blue text-white hover:bg-wellness-blue/90 shadow-card",
        premium:
          "bg-wellness-amber text-accent-foreground hover:bg-wellness-amber/90 shadow-card",
        outline:
...
const WellnessButton = React.forwardRef(
